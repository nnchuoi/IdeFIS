...
uint8_t MeColorSensor::Returnresult(void)
{
  ...
  if(Redvalue > 4000 && Greenvalue > 7000 && Bluevalue > 4000){
    result = WHITE;
  }else if(Redvalue > 3200 && Redvalue < 3800 && Greenvalue > 1500 && Greenvalue < 2100 && Bluevalue > 550 && Bluevalue < 1150){
    result = RED;
  }else if(Redvalue > 550 && Redvalue < 1550 && Greenvalue > 2900 && Greenvalue < 3900 && Bluevalue > 500 && Bluevalue < 1500){
    result = GREEN;
  }else if(Redvalue > 200 && Redvalue < 1200 && Greenvalue > 250 && Greenvalue < 1250 && Bluevalue < 1000){
    result = BROWN;
  }else if(Redvalue > 350 && Redvalue < 1350 && Greenvalue > 3500 && Greenvalue < 4500 && Bluevalue > 3300 && Bluevalue < 4300){
    result = BLUE;
  }else{
    result = BLACK;
  }
  ...
  // if(Redvalue < 1200 && Greenvalue < 1700 && Bluevalue < 1200)
  // {
  //   if(Greenvalue + Redvalue + Bluevalue <500)
  //   {
  //       result = BLACK;
  //   }
